...
<div class="container-fluid bapp-container">
    ...
    <!-- REKAP TONASE PASOK -->
    <h4 style="margin-top: 1rem;">REKAP TONASE PASOK</h4>
    ...
    <div class="d-flex justify-content-between mt-4">
        <div>
            <a href="{{ route('bapp.index') }}" class="btn btn-secondary me-2">
    ...
    <div class="modal fade" id="submitBappModal" tabindex="-1" aria-labelledby="submitBappModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="submitBappModalLabel">Konfirmasi Pengajuan BAPP</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin mengajukan BAPP ini ke Vendor?</p>
                    <p class="mb-0">Pastikan semua data sudah benar sebelum mengajukan.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <form action="{{ route('bapp.approval.submit-vendor', $bapp->kode_bapp) }}" method="POST" id="submitBappForm">
                        @csrf
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-paper-plane me-1"></i> Ya, Ajukan
                        </button>
                    </form>
                </div>
            </div>
