...
<div class="vendor-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-xl font-semibold text-gray-800">Edit Jenis Unit</h2>
        <a href="{{ route('jenis-unit.index') }}" class="text-sm text-gray-600 hover:text-gray-900">
            <i class="fas fa-arrow-left mr-1"></i> Kembali ke Daftar
        </a>
    </div>
    
    <form action="{{ route('jenis-unit.update', $jenisUnit->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" name="jenis_unit" id="jenis_unit" 
                   ...
                   value="{{ old('jenis_unit', $jenisUnit->jenis_unit) }}" required>
            @error('jenis_unit')
